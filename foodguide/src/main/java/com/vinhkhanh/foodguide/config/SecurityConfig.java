...
import com.vinhkhanh.foodguide.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Cho phép tất cả origins (có thể thay bằng danh sách cụ thể trong production)
        configuration.setAllowedOrigins(List.of("*"));
        configuration.setAllowedMethods(Arrays.asList("GET", "POST", "PUT", "DELETE", "OPTIONS", "PATCH"));
        configuration.setAllowedHeaders(List.of("*"));
        // Cho phép credentials nếu cần (có thể bật khi cần thiết)
        configuration.setAllowCredentials(false);
        // Cache preflight requests trong 1 giờ
        configuration.setMaxAge(3600L);
        // Expose headers cho mobile apps
